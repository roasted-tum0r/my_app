...
export function useheader1Cb() {
	const onClick = useCallback(callbackFactory("header1", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useright_button_flexCb() {
	const onClick = useCallback(callbackFactory("right_button_flex", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useresturant_flexCb() {
	const onClick = useCallback(callbackFactory("resturant_flex", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useresturant_logoCb() {
	const onClick = useCallback(callbackFactory("resturant_logo", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function uselogo_buttonsCb() {
	const onClick = useCallback(callbackFactory("logo_buttons", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function usebody2Cb() {
	const onClick = useCallback(callbackFactory("body2", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
